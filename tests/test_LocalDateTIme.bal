...
function testOfBasic_LocalDateTime() {
    LocalDateTime dt = ofDateTime(2026, 7, 15, 14, 28);
...
@test:Config {}
function testOfFull() {
    LocalDateTime dt = ofWithSeconds(2026, 7, 15, 14, 28, 19);
    test:assertEquals(dt.toString(), "2026-07-15T14:28:19");
}

@test:Config {}
function testOfFullWithNano() {
    LocalDateTime dt = ofWithNanos(2026, 7, 15, 14, 28, 19, 500000000);
...
function testToStringFormat() {
    LocalDateTime dt = ofWithSeconds(2026, 1, 5, 9, 3, 7);
...
function testGetDayOfYear_LocalDateTime() {
    LocalDateTime dt = ofDateTime(2026, 2, 1, 0, 0);
...
function testGetNano() {
    LocalDateTime dt = ofWithNanos(2026, 7, 15, 14, 28, 19, 123456789);
    test:assertEquals(dt.getNano(), 123456789);
}

@test:Config {}
function testHashCodeConsistency() {
    LocalDateTime dt1 = ofDateTime(2026, 7, 15, 14, 28);
    LocalDateTime dt2 = ofDateTime(2026, 7, 15, 14, 28);
...
function testEqualsFalseForDifferentValues() {
    LocalDate dt1 = ofDate(2026, 7, 15);
    LocalDateTime dt2 = ofDateTime(2026, 7, 15, 14, 29);
...
function testToLocalDateAndTimeRoundTrip() {
    LocalDateTime original = ofWithSeconds(2026, 7, 15, 14, 28, 19);
...
function testPlusMonthsClampsShorterMonth_LocalDateTime() {
    ...
    LocalDateTime dt = ofDateTime(2026, 1, 31, 10, 0);
    LocalDateTime next = dt.plusMonths(1);
...
function testPlusHours() {
    LocalDateTime dt = ofWithSeconds(2026, 7, 15, 10, 0, 0);
...
function testPlusHoursCrossesMidnightIntoNextDay() {
    ...
    LocalDateTime dt = ofDateTime(2026, 7, 15, 23, 0);
    LocalDateTime next = dt.plusHours(2);
...
function testPlusMinutes() {
    LocalDateTime dt = ofDateTime(2026, 7, 15, 14, 50);
...
function testPlusSeconds() {
    LocalDateTime dt = ofWithSeconds(2026, 7, 15, 14, 28, 50);
...
function testPlusNanos() {
    LocalDateTime dt = ofWithNanos(2026, 7, 15, 0, 0, 0, 900000000);
...
function testMinusHoursCrossesMidnightIntoPreviousDay() {
    LocalDateTime dt = ofDateTime(2026, 7, 15, 1, 0);
...
function testMinusMinutes() {
    LocalDateTime dt = ofDateTime(2026, 7, 15, 10, 5);
...
function testMinusSeconds() {
    LocalDateTime dt = ofWithSeconds(2026, 7, 15, 10, 1, 10);
...
function testMinusNanos() {
    LocalDateTime dt = ofWithNanos(2026, 7, 15, 0, 0, 1, 100000000);
...
function testWithDayOfYear_LocalDateTime() {
    LocalDateTime dt = ofDateTime(2026, 1, 1, 0, 0);
...
function testWithMethodsChainImmutability() {
    LocalDateTime original = ofDateTime(2026, 7, 15, 14, 28);
...
function testComplexScenario() {
    LocalDateTime dt = ofDateTime(2026, 1, 31, 23, 30);
...
function testWithInvalidHourThrows() {
    LocalDateTime dt = ofDateTime(2026, 7, 15, 10, 0);
