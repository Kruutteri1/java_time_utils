...
function testToStringFormat() {
    jt:LocalDateTime dt = jt:LocalDateTime_ofFull(2026, 1, 5, 9, 3, 7);
...
function testGetDayOfYear_LocalDateTime() {
    jt:LocalDateTime dt = jt:LocalDateTime_of(2026, 2, 1, 0, 0);
...
function testGetNano() {
    jt:LocalDateTime dt = jt:LocalDateTime_ofFullWithNano(2026, 7, 15, 14, 28, 19, 123456789);
    test:assertEquals(dt.getNano(), 123456789);
}

@test:Config {}
function testHashCodeConsistency() {
    jt:LocalDateTime dt1 = jt:LocalDateTime_of(2026, 7, 15, 14, 28);
    jt:LocalDateTime dt2 = jt:LocalDateTime_of(2026, 7, 15, 14, 28);
...
function testEqualsTrueForSameValues() {
    jt:LocalDateTime dt1 = jt:LocalDateTime_of(2026, 7, 15, 14, 28);
    jt:LocalDateTime dt2 = jt:LocalDateTime_of(2026, 7, 15, 14, 28);
    test:assertTrue(dt1.'equals(dt2), "Identical date-times should be equal");
}

@test:Config {}
function testEqualsFalseForDifferentValues() {
    jt:LocalDateTime dt1 = jt:LocalDateTime_of(2026, 7, 15, 14, 28);
    jt:LocalDateTime dt2 = jt:LocalDateTime_of(2026, 7, 15, 14, 29);
    test:assertFalse(dt1.'equals(dt2), "Different date-times should not be equal");
}
...
function testToLocalDateAndTimeRoundTrip() {
    jt:LocalDateTime original = jt:LocalDateTime_ofFull(2026, 7, 15, 14, 28, 19);
    jt:LocalDate d = original.toLocalDate();
    jt:LocalTime t = original.toLocalTime();
    jt:LocalDateTime rebuilt = jt:LocalDateTime_ofLocalDateWithLocalTime(d, t);
...
function testPlusMonthsClampsShorterMonth_LocalDateTime() {
    ...
    jt:LocalDateTime dt = jt:LocalDateTime_of(2026, 1, 31, 10, 0);
    jt:LocalDateTime next = dt.plusMonths(1);
...
function testPlusHours() {
    jt:LocalDateTime dt = jt:LocalDateTime_ofFull(2026, 7, 15, 10, 0, 0);
...
function testPlusHoursCrossesMidnightIntoNextDay() {
    ...
    jt:LocalDateTime dt = jt:LocalDateTime_of(2026, 7, 15, 23, 0);
    jt:LocalDateTime next = dt.plusHours(2);
...
function testPlusMinutes() {
    jt:LocalDateTime dt = jt:LocalDateTime_of(2026, 7, 15, 14, 50);
...
function testPlusSeconds() {
    jt:LocalDateTime dt = jt:LocalDateTime_ofFull(2026, 7, 15, 14, 28, 50);
...
function testPlusNanos() {
    jt:LocalDateTime dt = jt:LocalDateTime_ofFullWithNano(2026, 7, 15, 0, 0, 0, 900000000);
...
function testMinusHoursCrossesMidnightIntoPreviousDay() {
    jt:LocalDateTime dt = jt:LocalDateTime_of(2026, 7, 15, 1, 0);
...
function testMinusMinutes() {
    jt:LocalDateTime dt = jt:LocalDateTime_of(2026, 7, 15, 10, 5);
...
function testMinusSeconds() {
    jt:LocalDateTime dt = jt:LocalDateTime_ofFull(2026, 7, 15, 10, 1, 10);
...
function testMinusNanos() {
    jt:LocalDateTime dt = jt:LocalDateTime_ofFullWithNano(2026, 7, 15, 0, 0, 1, 100000000);
...
function testWithDayOfYear_LocalDateTime() {
    jt:LocalDateTime dt = jt:LocalDateTime_of(2026, 1, 1, 0, 0);
...
function testWithMethodsChainImmutability() {
    jt:LocalDateTime original = jt:LocalDateTime_of(2026, 7, 15, 14, 28);
...
function testComplexScenario() {
    jt:LocalDateTime dt = jt:LocalDateTime_of(2026, 1, 31, 23, 30);
...
function testInvalidHourThrows() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_of(2026, 7, 15, 24, 0);
    test:assertTrue(dt is error);
}

@test:Config {}
function testInvalidMinuteThrows() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_of(2026, 7, 15, 10, 60);
    test:assertTrue(dt is error);
}

@test:Config {}
function testInvalidDayInDateTimeThrows() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_of(2026, 2, 30, 0, 0);
    test:assertTrue(dt is error);
}

@test:Config {}
function testInvalidSecondThrows() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_ofFull(2026, 7, 15, 10, 0, 60);
    test:assertTrue(dt is error);
}

@test:Config {}
function testWithInvalidHourThrows() {
    jt:LocalDateTime dt = jt:LocalDateTime_of(2026, 7, 15, 10, 0);
...
function testHourNegativeThrows() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_of(2026, 7, 15, -1, 0);
    test:assertTrue(dt is error);
}
...
function testHour23IsValid() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_of(2026, 7, 15, 23, 0);
    test:assertTrue(dt is jt:LocalDateTime);
}

@test:Config {}
function testHour0IsValid() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_of(2026, 7, 15, 0, 0);
    test:assertTrue(dt is jt:LocalDateTime);
}
...
function testMinuteNegativeThrows() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_of(2026, 7, 15, 10, -1);
    test:assertTrue(dt is error);
}
...
function testMinute59IsValid() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_of(2026, 7, 15, 10, 59);
    test:assertTrue(dt is jt:LocalDateTime);
}
...
function testSecondNegativeThrows() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_ofFull(2026, 7, 15, 10, 0, -1);
    test:assertTrue(dt is error);
}
...
function testSecond59IsValid() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_ofFull(2026, 7, 15, 10, 0, 59);
    test:assertTrue(dt is jt:LocalDateTime);
}
...
function testNanoNegativeThrows() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_ofFullWithNano(2026, 7, 15, 10, 0, 0, -1);
    test:assertTrue(dt is error);
}
...
function testNano1000000000Throws() {
    // максимум 999999999
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_ofFullWithNano(2026, 7, 15, 10, 0, 0, 1000000000);
    test:assertTrue(dt is error);
}

@test:Config {}
function testNano999999999IsValid() {
    jt:LocalDateTime|error dt = trap jt:LocalDateTime_ofFullWithNano(2026, 7, 15, 10, 0, 0, 999999999);
    test:assertTrue(dt is jt:LocalDateTime);
}
