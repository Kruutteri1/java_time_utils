...
function testOfEpochDayNegative() {
    jt:LocalDate d = jt:LocalDate_ofEpochDay(-1);
...
function testOfYearDay() {
    jt:LocalDate d = jt:LocalDate_ofYearDay(2026, 1);
...
function testToStringFormat_LocalDate() {
    jt:LocalDate d = jt:LocalDate_of(2026, 1, 5);
...
function testGetDayOfYear() {
    jt:LocalDate d = jt:LocalDate_of(2026, 2, 1);
    test:assertEquals(d.getDayOfYear(), 32, "February 1st should be day 32 of the year");
}

@test:Config {}
function testHashCodeConsistency_LocalDate() {
    jt:LocalDate d1 = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate d2 = jt:LocalDate_of(2026, 7, 15);
...
function testEqualsTrueForSameValues_LocalDate() {
    jt:LocalDate d1 = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate d2 = jt:LocalDate_of(2026, 7, 15);
    test:assertTrue(d1.'equals(d2), "Identical dates should be equal");
}

@test:Config {}
function testEqualsFalseForDifferentDates() {
    jt:LocalDate d1 = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate d2 = jt:LocalDate_of(2026, 7, 16);
    test:assertFalse(d1.'equals(d2), "Different dates should not be equal");
}
...
function testIsLeapYearTrue() {
    jt:LocalDate d = jt:LocalDate_of(2024, 1, 1);
...
function testIsLeapYearCentury() {
    ...
    jt:LocalDate d = jt:LocalDate_of(1900, 1, 1);
...
function testLengthOfMonthFebruaryLeap() {
    jt:LocalDate d = jt:LocalDate_of(2024, 2, 1);
...
function testPlusWeeks() {
    jt:LocalDate d = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate next = d.plusWeeks(1);
...
function testPlusYears() {
    jt:LocalDate d = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate next = d.plusYears(1);
...
function testPlusYearsLeapDayClamped() {
    ...
    jt:LocalDate d = jt:LocalDate_of(2024, 2, 29);
    jt:LocalDate next = d.plusYears(1);
...
function testMinusWeeks() {
    jt:LocalDate d = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate prev = d.minusWeeks(1);
...
function testMinusYears() {
    jt:LocalDate d = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate prev = d.minusYears(1);
...
function testWithYear() {
    jt:LocalDate d = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate changed = d.withYear(2030);
...
function testWithMonth() {
    jt:LocalDate d = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate changed = d.withMonth(1);
...
function testWithDayOfMonth() {
    jt:LocalDate d = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate changed = d.withDayOfMonth(1);
...
function testWithDayOfYear() {
    jt:LocalDate d = jt:LocalDate_of(2026, 1, 1);
    jt:LocalDate changed = d.withDayOfYear(200);
    test:assertEquals(changed.getDayOfYear(), 200);
}

@test:Config {}
function testWithMethodsChainImmutability_LocalDate() {
    jt:LocalDate original = jt:LocalDate_of(2026, 7, 15);
    jt:LocalDate _ = original.withYear(2030).withMonth(1).withDayOfMonth(1);
...
function testComplexScenario_LocalDate() {
    jt:LocalDate d = jt:LocalDate_of(2026, 1, 31);
    jt:LocalDate result = d.plusMonths(1).plusDays(10);
...
function testInvalidMonthThrows() {
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, 13, 1);
    test:assertTrue(d is error);
}

@test:Config {}
function testInvalidMonthZeroThrows() {
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, 0, 1);
    test:assertTrue(d is error);
}

@test:Config {}
function testInvalidDayThrows() {
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, 1, 32);
    test:assertTrue(d is error);
}

@test:Config {}
function testFeb30NeverValidThrows() {
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, 2, 30);
    test:assertTrue(d is error);
}
...
function testFeb29OnNonLeapYearThrows() {
    ...
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, 2, 29);
    test:assertTrue(d is error);
}
...
function testWithInvalidDayOfMonthThrows() {
    jt:LocalDate d = jt:LocalDate_of(2026, 2, 1);
    jt:LocalDate|error result = trap d.withDayOfMonth(30);
...
function testWithInvalidMonthThrows() {
    jt:LocalDate d = jt:LocalDate_of(2026, 1, 1);
    jt:LocalDate|error result = trap d.withMonth(13);
    test:assertTrue(result is error);
}
...
function testInvalidDayOfYearThrows() {
    ...
    jt:LocalDate|error d = trap jt:LocalDate_ofYearDay(2026, 366);
    test:assertTrue(d is error);
}
...
function testMonthNegativeThrows() {
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, -1, 1);
    test:assertTrue(d is error);
}
...
function testMonth12IsValid() {
    ...
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, 12, 1);
    test:assertTrue(d is jt:LocalDate);
}
...
function testDayZeroThrows() {
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, 1, 0);
    test:assertTrue(d is error);
}
...
function testDay31InJanuaryIsValid() {
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, 1, 31);
    test:assertTrue(d is jt:LocalDate);
}
...
function testDay31InAprilThrows() {
    ...
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, 4, 31);
    test:assertTrue(d is error);
}

@test:Config {}
function testDay30InAprilIsValid() {
    jt:LocalDate|error d = trap jt:LocalDate_of(2026, 4, 30);
    test:assertTrue(d is jt:LocalDate);
}
...
function testDayOfYearZeroThrows() {
    jt:LocalDate|error d = trap jt:LocalDate_ofYearDay(2026, 0);
    test:assertTrue(d is error);
}
...
function testDayOfYear366OnLeapYearIsValid() {
    jt:LocalDate|error d = trap jt:LocalDate_ofYearDay(2024, 366);
    test:assertTrue(d is jt:LocalDate);
}

@test:Config {}
function testDayOfYear367Throws() {
    jt:LocalDate|error d = trap jt:LocalDate_ofYearDay(2024, 367);
    test:assertTrue(d is error);
}

@test:Config {}
function testDayOfYear365IsValid() {
    jt:LocalDate|error d = trap jt:LocalDate_ofYearDay(2026, 365);
    test:assertTrue(d is jt:LocalDate);
}