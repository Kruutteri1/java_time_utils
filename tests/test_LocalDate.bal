...
function testOfYearDay() {
    jt:LocalDate d = jt:ofYearDay(2026, 1);
...
function testOfYearDayMidYear() {
    ...
    jt:LocalDate d = jt:ofYearDay(2026, 200);
    test:assertEquals(d.getMonthValue(), 7);
...
function testConstantsMin() {
    jt:LocalDate min = jt:getMINDate();
...
function testConstantsMax_LocalDate() {
    jt:LocalDate max = jt:getMAXDate();
...
function testConstantsEpoch() {
    jt:LocalDate epoch = jt:getEPOCHDate();
...
function testToStringFormat_LocalDate() {
    jt:LocalDate d = jt:ofDate(2026, 1, 5);
...
function testEqualsFalseForDifferentDates() {
    jt:LocalDate d1 = jt:ofDate(2026, 7, 15);
    jt:LocalDate d2 = jt:ofDate(2026, 7, 16);
    jt:LocalDateTime d3 = jt:getCurrentDateTime();
...
function testIsLeapYearTrue() {
    jt:LocalDate d = jt:ofDate(2024, 1, 1);
...
function testIsLeapYearCentury() {
    ...
    jt:LocalDate d = jt:ofDate(1900, 1, 1);
...
function testLengthOfMonthFebruaryLeap() {
    jt:LocalDate d = jt:ofDate(2024, 2, 1);
...
function testPlusDaysMonthRollover() {
    jt:LocalDate d = jt:ofDate(2026, 1, 31);
    jt:LocalDate next = d.plusDays(1);
...
function testPlusMonthsYearRollover() {
    jt:LocalDate d = jt:ofDate(2026, 12, 15);
    jt:LocalDate next = d.plusMonths(1);
...
function testPlusYearsLeapDayClamped() {
    ...
    jt:LocalDate d = jt:ofDate(2024, 2, 29);
    jt:LocalDate next = d.plusYears(1);
...
function testMinusDaysMonthRollover() {
    jt:LocalDate d = jt:ofDate(2026, 3, 1);
    jt:LocalDate prev = d.minusDays(1);
...
function testMinusMonthsYearRollover() {
    jt:LocalDate d = jt:ofDate(2026, 1, 15);
    jt:LocalDate prev = d.minusMonths(1);
...
function testWithMethodsChainImmutability_LocalDate() {
    jt:LocalDate original = jt:ofDate(2026, 7, 15);
...
function testInvalidMonthThrows() {
    jt:LocalDate|error d = trap jt:ofDate(2026, 13, 1);
    test:assertTrue(d is error);
}

@test:Config {}
function testInvalidMonthZeroThrows() {
    jt:LocalDate|error d = trap jt:ofDate(2026, 0, 1);
    test:assertTrue(d is error);
}

@test:Config {}
function testInvalidDayThrows() {
    jt:LocalDate|error d = trap jt:ofDate(2026, 1, 32);
    test:assertTrue(d is error);
}
...
function testFeb29OnNonLeapYearThrows() {
    ...
    jt:LocalDate|error d = trap jt:ofDate(2026, 2, 29);
    test:assertTrue(d is error);
}
...
function testInvalidDayOfYearThrows() {
    ...
    jt:LocalDate|error d = trap jt:ofYearDay(2026, 366);
    test:assertTrue(d is error);
}
...
function testMonthNegativeThrows() {
    jt:LocalDate|error d = trap jt:ofDate(2026, -1, 1);
    test:assertTrue(d is error);
}
...
function testMonth12IsValid() {
    ...
    jt:LocalDate|error d = trap jt:ofDate(2026, 12, 1);
...
function testDayZeroThrows() {
    jt:LocalDate|error d = trap jt:ofDate(2026, 1, 0);
    test:assertTrue(d is error);
}
...
function testDay31InJanuaryIsValid() {
    jt:LocalDate|error d = trap jt:ofDate(2026, 1, 31);
    test:assertTrue(d is jt:LocalDate);
}
...
function testDay31InAprilThrows() {
    ...
    jt:LocalDate|error d = trap jt:ofDate(2026, 4, 31);
    test:assertTrue(d is error);
}

@test:Config {}
function testDay30InAprilIsValid() {
    jt:LocalDate|error d = trap jt:ofDate(2026, 4, 30);
    test:assertTrue(d is jt:LocalDate);
}
...
function testDayOfYearZeroThrows() {
    jt:LocalDate|error d = trap jt:ofYearDay(2026, 0);
    test:assertTrue(d is error);
}
...
function testDayOfYear366OnLeapYearIsValid() {
    jt:LocalDate|error d = trap jt:ofYearDay(2024, 366);
    test:assertTrue(d is jt:LocalDate);
}

@test:Config {}
function testDayOfYear367Throws() {
    jt:LocalDate|error d = trap jt:ofYearDay(2024, 367);
    test:assertTrue(d is error);
}

@test:Config {}
function testDayOfYear365IsValid() {
    jt:LocalDate|error d = trap jt:ofYearDay(2026, 365);
    test:assertTrue(d is jt:LocalDate);
}
